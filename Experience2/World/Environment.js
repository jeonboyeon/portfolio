...
export default class Room {
    ...
    setSunlight() {
        ...
        this.sunLight.position.set(4, 40, 5);
    ...
    setSunlight2() {
        this.sunLight2 = new THREE.DirectionalLight("#ffffff", 10);
        ...
        this.sunLight2.position.set(-10, -40, -50);
    ...
    setSunlight3() {
        this.sunLight2 = new THREE.DirectionalLight("#ffffff", 4);
        this.sunLight2.castShadow = true;
        this.sunLight2.shadow.mapSize.set(1024, 1024);
        this.sunLight2.shadow.normalBias = 1;
        // this.sunLight2.shadow.camera.left = -100;
        ...
        // this.sunLight2.shadow.camera.near = -100;
        // this.sunLight2.shadow.camera.far = 100;
        this.sunLight2.position.set(100, -20, 10);
        this.scene.add(this.sunLight2);
    ...
    setRealLight() {
        this.realLight = new THREE.HemisphereLight(0xffffff, 20);
